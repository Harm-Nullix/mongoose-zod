...
if (!z5.z.ZodObject.prototype.mongoose) {
  z5.z.ZodObject.prototype.mongoose = function(metadata = {}) {
...
if (!z5.z.ZodType.prototype.mongooseTypeOptions) {
  z5.z.ZodType.prototype.mongooseTypeOptions = function(options) {
