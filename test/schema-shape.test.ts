...
describe('Schema shape replication', () => {
  ...
  it.each([
    ...
    {zodType: 'bigint', schema: z.bigint(), type: 'BigInt'},
    {zodType: 'bigint literal', schema: z.literal(1n), type: 'BigInt'},
    {zodType: 'bigint native enum', schema: z.nativeEnum({A: 1n} as any), type: 'BigInt'},
